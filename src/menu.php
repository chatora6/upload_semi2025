...
<div class="nav-container">
  ...
  <div class="menu_content">
    <?php
    if(isAdmin()){
      echo '<li><a href="form.php" style="color:white">新規アップロード</a></li>';
    }
    ?>
    <li><a href="home.php">HOME</a></li>
    <li><a href="show.php?genre=すべて">すべてのファイル</a></li>
    <li><a href="show.php?genre=業務マニュアル">業務マニュアル</a></li>
    ...
    <li><a href="logout.php" onclick="return confirm('ログアウトしますか？')" style="color: #ff4444;">ログアウト</a></li>
  </div>
</div>
